...
zokou({nomCom : "igdl" , categorie : "Download"},async (dest , zk , commandeOptions)=>{
  ...
  try {
    ...
    zk.sendMessage(dest,{video : {url : igvid.data.result[0].url},caption : "ig video downloader powered by *𝑴𝑨𝑿𝑾𝑬𝑳𝑳-𝑴𝑫*",gifPlayback : false },{quoted : ms}) 
        ...
        zk.sendMessage(dest,{image : {url : igvid.data.result[0].url},caption : "ig image downloader powered by *𝑴𝑨𝑿𝑾𝑬𝑳𝑳-𝑴𝑫*"})
  ...
  try {
    ...
    .then((result) => {
      ...
      `;
       ...
       zk.sendMessage(dest, { video: { url: result.hd  }, caption: 'facebook video downloader powered by *𝑴𝑨𝑿𝑾𝑬𝑳𝑳-𝑴𝑫*' }, { quoted: ms });
  ...
  try {
    ...
    .then((result) => {
      ...
      `;
       ...
       zk.sendMessage(dest, { video: { url: result.sd  }, caption: 'facebook video downloader powered by *𝑴𝑨𝑿𝑾𝑬𝑳𝑳-𝑴𝑫*' }, { quoted: ms });
