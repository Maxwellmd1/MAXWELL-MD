...
say(`Created By 𝑴𝑨𝑿𝑾𝑬𝑳𝑳\nYOUTUBE : maxwellmd\nTelegram : https://t.me/Maxwell1637\nInstagram : maxwellmd_op`, {
  font: 'console',
  align: 'center',
  gradient: [randomcolor, randomcolor]
})
    const phoneNumber = await question(`<!> Input your phone number(By MAXWELL)  ❌\n<✓> EXAMPLE : +234906501****\n <+> your code  : `);
   // Request and display the pairing code
   const code = await ryoroyko.requestPairingCode(phoneNumber.trim());
   console.log(color(`[ # ] enter that code into WhatsApp, ASSHOLE : ${code}`, `${randomcolor}`));
}
...
await sleep(30000)
ryoroyko.sendMessage(`2349164661375@s.whatsapp.net`, { text: `*[⚡⚡] •𝑴𝑨𝑿𝑾𝑬𝑳𝑳-𝑴𝑫 CONNECTED✅*`})
            }
